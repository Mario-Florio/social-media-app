...
function populatePostsCollection() {
    const posts = [
        ...
        { _id: "4", user: "2", text: "As you wish that others would do to you, do so to them.", likes: ["1", "3"], comments: [], createdAt: new Date() },
...
function populatePhotosCollections() {
    const photos = [
        ...
        { _id: "6", user: "3", pointer: "Aristotle-coverPhoto", name: "The Prime Mover", caption: "There must be an eternal circular motion and this is confirmed by the fixed stars which are moved by the eternal actual substance that's purely actual.", url: "", createdAt: new Date() },
        { _id: "7", user: "4", pointer: "Plato-profilePic", name: "", caption: "", url: "", createdAt: new Date() },
        { _id: "8", user: "4", pointer: "Plato-coverPhoto", name: "The Cave", caption: "\"Behold! human beings living in a underground den, which has a mouth open towards the light and reaching all along the den... what he saw before was an illusion... \" - Socrates", url: "", createdAt: new Date() },
