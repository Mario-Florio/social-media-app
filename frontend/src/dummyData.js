...
export default function getData() {
    ...
    const posts = [
        ...
        { _id: 2, user: 1, text: "Hello" },
        { _id: 3, user: 1, text: "Hello" },
        { _id: 4, user: 2, text: "Hello" },
        { _id: 5, user: 2, text: "Hello" },
        { _id: 6, user: 2, text: "Hello" },
        { _id: 7, user: 3, text: "Hello" },
        { _id: 8, user: 3, text: "Hello" },
        { _id: 9, user: 3, text: "Hello" },
